  ...
  return (
    <>
          ...
          <Row md={12} gap={4}>
            ...
            >
              <Row className="p-md-5">
                ...
                <h3 className="fs-2 text-white fw-normal">
                  Fuzhio promotes Impact Products
                </h3>
                <p
                  className="text-white"
                  style={{ lineHeight: "32px", fontSize: "18px" }}
                >
                  Fuzhio strives to improve value chains and make them equitable
                  and sustainable. Our market-led activities unlock business
                  opportunities for vulnerable communities, and enhance
                  socio-economic and environmental value for all stakeholders.
                  Our environmentally-aligned initiatives create mutual
                  synergies for stakeholders, value-added products for farmers
                  and partners, and profits for all involved.
                </p>
                <div>
                  <a
                    href="/about/"
      ...
      <Container
        ...
        style={{ backgroundColor: "#6e180C29" }}
      >
      ...
      <Container>
        <Row className="d-flex d-md-row flex-md-row flex-column justify-content-center">
          {/* Row 1 */}
          <Col
            className="d-flex flex-column flex-row justify-content-between our-dirc p-md-5 laro-regular p-5 w-100"
            style={{}}
          >
            <p className="text-white p-0 lh-lg ">
              The products in the value chains that we enhance ensure positive
          ...
          <Col className="d-flex flex-column justify-content-between our-dirc-1  p-md-5 laro-regular p-5 w-100">
            <p className="text-white p-0 lh-lg">
              We make the markets work for the poor. Our workforce is comprised
              of smallholder farmers, women, and members of various marginalised
              communities
            </p>
            <div className="border border-3 w-25 d-md-block d-none "></div>
          </Col>
          <Col className="d-flex flex-column justify-content-between our-dirc our-dirc-2  p-md-5 laro-regular p-5 ">
            <p className="text-white p-0 lh-lg ">
              Returns from our initiatives flow directly to our community
              stakeholders, thus making our system equitable
            </p>
            <div className="border border-3 w-25 d-md-block d-none "></div>
          </Col>
          <Col className="d-flex flex-column justify-content-between our-dirc our-dirc-3  p-md-5 laro-regular p-5 ">
            <p className="text-white p-0 lh-lg ">
              We not only improve market linkages, but also integrate our
              stakeholders into unique business opportunities
            </p>
            <div className="border border-3 w-25 d-md-block d-none "></div>
          </Col>
          <Col className="d-flex flex-column justify-content-between our-dirc our-dirc-4  p-md-5 laro-regular p-5 ">
            <p className="text-white p-0 lh-lg ">
              We enable traceability and transparency, and promise quality
              assurance of all our products
            </p>
            <div className="border border-3 w-25 d-md-block d-none "></div>
          </Col>
        </Row>
      ...
      <Container fluid className="parters-bg">
        <Container>
          <Col className="text-center">
            <h1
              className="d-inline-block d-none text-center pb-4 px-5"
              style={{
                color: "#923022",
                borderBottom: "2px solid #923022",
                letterSpacing: "5px",
